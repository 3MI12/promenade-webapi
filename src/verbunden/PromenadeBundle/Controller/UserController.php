...
use verbunden\PromenadeBundle\UserInterface;
...
class UserController extends FOSRestController {
     ...
     *   output = "verbunden\PromenadeBundle\Entity\User",
     *   statusCodes = {
    ...
    public function getShowAction($user_name) {
        return $this->container->get('verbunden_Promenade.user.handler')->showUser($user_name);
    }
    ...
    public function postLoginAction(Request $request, ParamFetcherInterface $paramFetcher) {
        return $this->container->get('verbunden_Promenade.user.handler')->loginUser($request->request->all());
    }
    ...
    public function postLogoutAction(Request $request, ParamFetcherInterface $paramFetcher) {
        return $accessKey = $this->container->get('verbunden_Promenade.user.handler')->logoutUser($request->request->all());
    }
